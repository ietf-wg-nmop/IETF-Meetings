...
|:-------------:|:-----------------:|:-----:|:-----:|:----------------|:--------|:--------|
| 20 | YANG Template Framework | Px | Robert Peschi | 20    | | OK (teaser) |
| 15 | Knowledge Graphs for YANG-based Network Management | Px | Nacho | 35  | Yes  | NOK |
| 10 | SAV-based Anti-DDoS Architecture | Px | Mingzhe Xing | 45    | | NOK |
| 20 | An Architecture for YANG-Push to Message Broker Integration | P1 | Thomas | 65  | Yes  | OK |
| 10 | An Architecture for a Network Anomaly Detection Framework | P2 | Thomas | 75   | Yes | OK (group A) |
| 10 | Semantic Metadata Annotation for Network Anomaly Detection | P2 | Thomas | 85  | Yes  | OK  (group A)|
| 15 | Validate Configured Subscription YANG-Push Publisher Implementations | P1 | Yannick | 100  | Yes  | OK |
| 20 | Operator/Implementer Contribution: YANG-Push Next Steps | P1/P4 | Thomas | 120   | Yes | OK |
| 10 |Experiment: Network Anomaly Lifecycle | P2 | Vincenzo | 130  | Yes  | OK  (split session 2/group A))|
| 15 |Digital Map | P3 | Olga | 145 |Yes   | OK (extended slot)|
